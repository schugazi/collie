...
describe("real corpus — pinned so any change to the walk shows up as a diff", () => {
  ...
  const PINNED: { fixture: string; statusRows: number; draft: string | null; stripped: number }[] = [
    ...
    // Claude's task panel parked under an open dialog's footer: a modal, so no box and no statusline.
    // The one stripped row is the tmux capture's trailing blank line.
    { fixture: "permission-bash--task-panel--w60", statusRows: 0, draft: null, stripped: 1 },
    ...
    { fixture: "wizard-long-question--task-panel", statusRows: 0, draft: null, stripped: 1 },
    { fixture: "wizard--queued-messages", statusRows: 0, draft: null, stripped: 0 },
    ...
    { fixture: "wizard-submit--task-panel", statusRows: 0, draft: null, stripped: 1 },
